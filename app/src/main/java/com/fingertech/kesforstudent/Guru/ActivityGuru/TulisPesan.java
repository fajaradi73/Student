...
public class TulisPesan extends AppCompatActivity {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (status == 1 && code.equals("DTS_SCS_0001")) {
                        ...
                        for (int i = 0; i < dataEdulevelList.size(); i++) {
                            ...
                            final ArrayAdapter<String> adapterRaport = new ArrayAdapter<String>(TulisPesan.this, R.layout.spinner_full, listEdulevel);
                    ...
                    if (status == 1 && code.equals("DTS_SCS_0001")) {
                        ...
                        if (listMapel != null) {
                            ...
                            for (int i = 0; i < response.body().getData().size(); i++) {
                                ...
                                final ArrayAdapter<String> adapterMapel = new ArrayAdapter<String>(TulisPesan.this, R.layout.spinner_full, listMapel);
                    ...
                    if (status == 1 && code.equals("DTS_SCS_0001")){
                        ...
                        if (listMurid!=null){
                            ...
                            for (int i = 0 ; i < response.body().getData().size();i++){
                                ...
                                final ArrayAdapter<String> adapterMurid = new ArrayAdapter<String>(TulisPesan.this, R.layout.spinner_full, listMurid);
                    ...
                    if (status == 1 && code.equals("DTS_SCS_0001")){
                        ...
                        if (listAdmin!=null){
                            ...
                            for (int i = 0 ; i < response.body().getData().size();i++){
                                ...
                                final ArrayAdapter<String> adapter = new ArrayAdapter<String>(TulisPesan.this, R.layout.spinner_full, listAdmin);
    ...
    public void progressBar(){
        dialog = new ProgressDialog(TulisPesan.this);
