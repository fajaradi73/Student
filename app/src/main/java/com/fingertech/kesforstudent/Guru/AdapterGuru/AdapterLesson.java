...
public class AdapterLesson extends RecyclerView.Adapter<AdapterLesson.MyHolder> {

    private List<ModelLesson> viewItemList;
    ...
    public AdapterLesson(Context context,List<ModelLesson> viewItemList,NotificationManagerCompat notificationManager,Activity activity) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        ModelLesson viewItem = viewItemList.get(position);
