...
public class JumatAdapter extends RecyclerView.Adapter<JumatAdapter.MyHolder> {

    private List<JadwalJumat> viewItemList;
    ...
    public void onBindViewHolder(MyHolder holder, int position) {
        ...
        JadwalJumat viewItem = viewItemList.get(position);
        // Set car item title.
